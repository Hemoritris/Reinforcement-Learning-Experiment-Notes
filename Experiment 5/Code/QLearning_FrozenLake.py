    ...
    def train(self, num_episodes=10000):
        ...
        for episode in range(num_episodes):
            ...
            while not done:
                ...
                # Q-Learning: 使用max Q(s',a')来更新 (关键区别)
                if done:
                    td_target = reward
                else:
                    td_target = reward + self.gamma * np.max(self.qvalue[next_state, :])
...
def plot_results(rewards, title="Q-Learning Learning Curve"):
    """绘制学习曲线"""
    ...
    plt.tight_layout()
    plt.savefig('QLearning_FrozenLake_results.png', dpi=150)
    plt.show()
...
if __name__ == '__main__':
    ...
    # 创建Q-Learning智能体
    agent = QLearning_Agent(env, alpha=0.1, gamma=0.99, epsilon=0.5)
    
    print("=" * 50)
    print("Q-Learning算法解决FrozenLake冰湖问题")
    print("=" * 50)
    ...
    # 绘制学习曲线
    plot_results(rewards, "Q-Learning")
